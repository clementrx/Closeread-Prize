...
theme_update(
  ...
  axis.text.x = element_text(size = 6, margin = margin(t = 5), angle = 45, hjust = 1),
...
ggplot(aes(x = Date, y = Mark, color = Gender)) + 
  ...
  labs(
    title = "Evolution of Javelin Throw distances (Men and Women)",
...
After the 1999 redesign of the javelin, the dynamics of the sport changed significantly. The new javelin, with its center of gravity moved forward, was more stable in flight and less prone to unpredictable distances.

The redesign also brought more consistency in performance, with athletes focusing on refining technique, precision, and speed within the new parameters. Although the record-breaking distances have decreased, the competition remains fierce, and the sport continues to evolve with each new generation of throwers. @cr-distance-men-zoom
